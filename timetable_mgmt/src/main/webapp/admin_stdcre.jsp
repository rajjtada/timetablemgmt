...
<html>
	...
	<body>
		...
		<div id="div_login">
		<h3>  Create Student User</h3><br>
		<form method="post" action="std_usercr">
			<input type="hidden" name="hid" value="S" >
			<input type="text" name="std_name" class="form-control" placeholder="Student's Name" style="width:250px"><br>
			<input type="number" name="eno" class="form-control" placeholder="Enrollement Number (Login ID)" style="width:250px"><br>
